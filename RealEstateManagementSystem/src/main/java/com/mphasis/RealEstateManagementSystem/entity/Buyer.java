...
public class Buyer{
	...
	public Buyer(int buyerId, UserCommonDetails ucd, PropertyManager property_manager, List<Plots> plotsList,
	...
	public String toString() {
		return "Buyer [buyerId=" + buyerId + ", ucd=" + ucd + ", property_manager=" + property_manager + ", plotsList="
				+ plotsList + ", aprtList=" + aprtList + ", indList=" + indList + ", user=" + user + "]";
	}
